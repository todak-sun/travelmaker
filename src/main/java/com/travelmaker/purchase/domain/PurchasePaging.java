...
public class PurchasePaging {
	...
	public void makePagingHTML() {
		...
		if (startPage > pageBlock) {
			pagingHTML.append("<li class='page-item'><a class='page-link' id='paging' href='/pur/list/"
					+ (startPage - 1) + "'>이전</a></li>");
		}

		for (int i = startPage; i <= endPage; i++) {
			if (i == currentPage) {
				pagingHTML.append("<li class='page-item active'><a class='page-link' id='paging' href='/pur/list/"
						+ i + "'>" + i + "</a></li>");
			} else {
				pagingHTML.append("<li class='page-item'><a class='page-link' id='paging' href='/pur/list/" + i
						+ "'>" + i + "</a></li>");
			}
		}
		if (endPage < totalP) {
