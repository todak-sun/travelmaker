...
public class AlarmApiController {
    ...
    public ResponseEntity<String> deleteAlarm(@PathVariable String con, @PathVariable String seq, @PathVariable String alarmType) {
        /* con : 1. 읽은 알람 지우기  */
        /* seq : userTable seq */
        /* alarmType : 알람종류  [1.전체 2.동행 3.구매 4.댓글]*/
    ...
    @DeleteMapping(path = "/deleteAlarm/{ano}", produces = "application/json; charset=UTF8")
    public ResponseEntity<String> delete(@PathVariable int ano) {
        return alarmService.delete(ano);
    }
}
