...
<nav id="main-nav" class="navbar navbar-expand-sm fixed-top bg-white">
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <sec:authorize access="hasRole('ROLE_USER') and isAuthenticated()">
        ...
        <p
          ...
          credentialsNonExpired, AccountNonLocked, Granted Authorities, SEQ,
          realName, nickName, img</p
        >
        --%>
      </sec:authorize>
      ...
      <sec:authorize access="hasRole('ROLE_USER') and isAuthenticated()"
        >--%> <%-- ${fn:substringBefore(user.username,"%")}--%> <%-- </sec:authorize
      >--%>
    </ul>
