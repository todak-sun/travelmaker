...
<!-- Google Map -->
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCeKdfxBMTEBPFzc4QjjrIJJv25EuWL4gY&libraries=places" async
        defer></script>
<!-- 웹 소켓 -->
...
<script src="${pageContext.request.contextPath}/resources/js/main/main2.js"></script>
=======
<%@ page contentType="text/html;charset=UTF-8" language="java"%>
<script
...
<script
	src="${pageContext.request.contextPath}/resources/js/common/travelmaker.js"></script>
<script src="http://developers.kakao.com/sdk/js/kakao.min.js"></script>
<script
...
<script
	src="${pageContext.request.contextPath}/resources/js/main/main2.js"></script>
>>>>>>> Stashed changes
