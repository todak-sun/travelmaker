...
<body>
	...
	<div class="container-wrap">
		<div class="editor-zone">
			<form action="" class="editor-second" id="routeWriteForm">
				<div class="hidden">
					<input type="hidden" name="is_domestic" id="is_domestic"
						value="${is_domestic}"> <input type="hidden" name="fno"
						id="fno" value="${fno}"> <input type="hidden"
						name="friendDateStart" id="friendDateStart"
						value="${friendDateStart }"> <input type="hidden"
						name="friendDateEnd" id="friendDateEnd" value="${friendDateEnd }">
					<input type="hidden" name="lat" id="lat"> <input
						type="hidden" name="lng" id="lng"> <input type="hidden"
						name="city" id="city"> <input type="hidden" name="fcno"
						id="fcno">
				</div>

				<div class="input-wrap">
					<label for="date-start">방문 시작일</label> <input type="date"
				...
				<div class="input-wrap">
					<label for="date-end">방문 종료일</label> <input type="date"
				...
				<div class="input-wrap place">
					<label for="input-search-place">장소</label> <input type="text"
	...
	<script
		src="${pageContext.request.contextPath}/resources/js/friend/routeModify.js"></script>
</body>
</html>