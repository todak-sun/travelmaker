    ...
    <div class="editor-zone">
        <form action="" class="editor-second" id="routeWriteForm">
            <div class="hidden">
                ...
                <input type="hidden" name="fno" id="fno" value="${fno}">
                ...
                <input type="hidden" name="fcno" id="fcno">
            </div>
...
<script src="${pageContext.request.contextPath}/resources/js/friend/routeModify.js"></script>
</body>
</html>