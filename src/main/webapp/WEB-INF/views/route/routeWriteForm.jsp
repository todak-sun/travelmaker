...
<html>
    ...
    <form id="route-write-form" name="route-write-form">
      ...
      <div class="route-info-form" style="display: none;">
        ...
        <div class="route-location">
          ...
          <button type="button" class="btn btn-xs btn-success" id="searchBtn" data-toggle="modal" data-target="#exampleModal">검색</button>
 			...
 			<div class="modal-dialog" role="document">
				<div class="modal-content">
					        	...
					        	<div class="option">
					            	<div>
					                	<form onsubmit="searchPlaces(); return false;">
					                    	...
					                    	<button type="submit" class="btn btn-xs btn-success" id="submit">검색하기</button> 
					                	</form>
					            	</div>
					        	</div>
					        	<hr>
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary" onclick="moveClose()">Save</button>
					</div>
 				</div>
			</div>
		</div>
  ...
  ></script>
	...
	<!-- kakao map -->
	<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=58d9a72c9db8da0b849a32734093767e&libraries=services"></script>
